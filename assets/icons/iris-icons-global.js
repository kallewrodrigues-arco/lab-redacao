...
const IRIS_ICON_FILE_KEY = 'oxRf3scNZycsYvu9lHNaXi';
...
const IRIS_ICON_NAMES = Object.keys(IRIS_ICONS).sort();

/** Sizes config */
const IRIS_ICON_SIZES = {
 ...
 */
function irisIconSrc(name, size = 'lg', basePath = '../icons') {
 ...
 */
function createIrisIconElement(name, size = 'lg', basePath = '../icons') {
 ...
 */
function initIrisIcons(basePath = '../icons') {
...
window.IRIS_ICONS = IRIS_ICONS;
window.IRIS_ICON_SIZES = IRIS_ICON_SIZES;
window.IRIS_ICON_NAMES = IRIS_ICON_NAMES;
