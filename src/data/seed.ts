...
function buildInitialDb(): Db {
  ...
  propostas: [
    // ── Propostas de demo (dados linkados a redações/devolutivas) ─────────────────
    {
      id: 'prop-1',
    ...
    },
    {
      ...
      colecaoId: 'col-1',
      dataAgendada: '2026-04-29',
      dataVisivel: '2026-05-02',
      status: 'agendada',
      imageUrl: '/images/pratique-redacao.jpg',
      turmaIds: ['turma-1', 'turma-2'],
    },
    {
      ...
      colecaoId: 'col-3',
      dataAgendada: '2026-05-06',
      dataVisivel: '2026-05-09',
      status: 'agendada',
      imageUrl: '/images/livro3.png',
      turmaIds: ['turma-2', 'turma-3'],
    },
    ...
    },
    {
      ...
      colecaoId: 'col-2',
      dataAgendada: '2026-05-20',
      dataVisivel: '2026-05-23',
      status: 'agendada',
      imageUrl: '/images/livro3.png',
      turmaIds: ['turma-2', 'turma-3'],
    },
    // ── Calendário semanal: 2 propostas por segunda-feira (fev–abr 2026) ─────────
    // Semana 1 — 02/02
    { id: 'prop-11', colecaoId: 'col-pr-1', dataAgendada: '2026-02-02', dataVisivel: '2026-02-02', status: 'agendada',
      titulo: 'O impacto do uso de agrotóxicos na saúde pública brasileira',
      imageUrl: '/images/pratique-redacao.jpg',
      turmaIds: ['turma-1', 'turma-2'] },
    { id: 'prop-12', colecaoId: 'col-l3-1', dataAgendada: '2026-02-02', dataVisivel: '2026-02-02', status: 'agendada',
      titulo: 'Desafios da inclusão digital para idosos no Brasil contemporâneo',
      imageUrl: '/images/livro3.png',
      turmaIds: ['turma-1'] },
    // Semana 2 — 09/02
    { id: 'prop-13', colecaoId: 'col-pr-2', dataAgendada: '2026-02-09', dataVisivel: '2026-02-09', status: 'descartada',
      titulo: 'A herança colonial e seus reflexos na desigualdade racial brasileira',
      imageUrl: '/images/pratique-redacao.jpg',
      turmaIds: ['turma-1', 'turma-2'] },
    { id: 'prop-14', colecaoId: 'col-l3-2', dataAgendada: '2026-02-09', dataVisivel: '2026-02-09', status: 'agendada',
      titulo: 'O papel da arte e da cultura na formação da identidade nacional',
      imageUrl: '/images/livro3.png',
      turmaIds: ['turma-1'] },
    // Semana 3 — 16/02
    { id: 'prop-15', colecaoId: 'col-pr-3', dataAgendada: '2026-02-16', dataVisivel: '2026-02-16', status: 'agendada',
      titulo: 'Saúde mental no ambiente escolar: desafios e responsabilidades',
      imageUrl: '/images/pratique-redacao.jpg',
      turmaIds: ['turma-1', 'turma-2'] },
    { id: 'prop-16', colecaoId: 'col-l3-3', dataAgendada: '2026-02-16', dataVisivel: '2026-02-16', status: 'agendada',
      titulo: 'A crise da representatividade política e o desengajamento da juventude',
      imageUrl: '/images/livro3.png',
      turmaIds: ['turma-1'] },
    // Semana 4 — 23/02
    { id: 'prop-17', colecaoId: 'col-pr-4', dataAgendada: '2026-02-23', dataVisivel: '2026-02-23', status: 'agendada',
      titulo: 'Segurança alimentar e o combate à fome: responsabilidades do Estado',
      imageUrl: '/images/pratique-redacao.jpg',
      turmaIds: ['turma-1', 'turma-2'] },
    { id: 'prop-18', colecaoId: 'col-l3-4', dataAgendada: '2026-02-23', dataVisivel: '2026-02-23', status: 'agendada',
      titulo: 'O modelo de negócios das plataformas digitais e seus impactos sociais',
      imageUrl: '/images/livro3.png',
      turmaIds: ['turma-2'] },
    // Semana 5 — 02/03
    { id: 'prop-19', colecaoId: 'col-pr-5', dataAgendada: '2026-03-02', dataVisivel: '2026-03-02', status: 'agendada',
      titulo: 'Violência urbana e suas raízes na desigualdade socioeconômica',
      imageUrl: '/images/pratique-redacao.jpg',
      turmaIds: ['turma-1', 'turma-2'] },
    { id: 'prop-20', colecaoId: 'col-l3-5', dataAgendada: '2026-03-02', dataVisivel: '2026-03-02', status: 'agendada',
      titulo: 'A privatização de serviços públicos essenciais no Brasil',
      imageUrl: '/images/livro3.png',
      turmaIds: ['turma-1'] },
    // Semana 6 — 09/03
    { id: 'prop-21', colecaoId: 'col-pr-6', dataAgendada: '2026-03-09', dataVisivel: '2026-03-09', status: 'descartada',
      titulo: 'Trabalho infantil: desafios para a erradicação no Brasil',
      imageUrl: '/images/pratique-redacao.jpg',
      turmaIds: ['turma-1', 'turma-2'] },
    { id: 'prop-22', colecaoId: 'col-l3-6', dataAgendada: '2026-03-09', dataVisivel: '2026-03-09', status: 'agendada',
      titulo: 'O impacto das mudanças climáticas nas populações mais vulneráveis',
      imageUrl: '/images/livro3.png',
      turmaIds: ['turma-2'] },
    // Semana 7 — 16/03
    { id: 'prop-23', colecaoId: 'col-pr-7', dataAgendada: '2026-03-16', dataVisivel: '2026-03-16', status: 'agendada',
      titulo: 'Desinformação e fake news: ameaças à democracia brasileira',
      imageUrl: '/images/pratique-redacao.jpg',
      turmaIds: ['turma-1', 'turma-2'] },
    { id: 'prop-24', colecaoId: 'col-l3-7', dataAgendada: '2026-03-16', dataVisivel: '2026-03-16', status: 'agendada',
      titulo: 'Acesso à saúde pública: os desafios do SUS no século XXI',
      imageUrl: '/images/livro3.png',
      turmaIds: ['turma-1'] },
    // Semana 8 — 23/03
    { id: 'prop-25', colecaoId: 'col-pr-8', dataAgendada: '2026-03-23', dataVisivel: '2026-03-23', status: 'agendada',
      titulo: 'A questão fundiária e os conflitos agrários no Brasil',
      imageUrl: '/images/pratique-redacao.jpg',
      turmaIds: ['turma-1', 'turma-2'] },
    { id: 'prop-26', colecaoId: 'col-l3-8', dataAgendada: '2026-03-23', dataVisivel: '2026-03-23', status: 'agendada',
      titulo: 'O envelhecimento da população e os desafios da previdência social',
      imageUrl: '/images/livro3.png',
      turmaIds: ['turma-2'] },
    // Semana 9 — 30/03
    { id: 'prop-27', colecaoId: 'col-pr-9', dataAgendada: '2026-03-30', dataVisivel: '2026-03-30', status: 'agendada',
      titulo: 'Discriminação étnico-racial no mercado de trabalho brasileiro',
      imageUrl: '/images/pratique-redacao.jpg',
      turmaIds: ['turma-1', 'turma-2'] },
    { id: 'prop-28', colecaoId: 'col-l3-9', dataAgendada: '2026-03-30', dataVisivel: '2026-03-30', status: 'descartada',
      titulo: 'A crise climática e o papel do Brasil nas negociações internacionais',
      imageUrl: '/images/livro3.png',
      turmaIds: ['turma-1'] },
    // Semana 10 — 06/04
    { id: 'prop-29', colecaoId: 'col-pr-10', dataAgendada: '2026-04-06', dataVisivel: '2026-04-06', status: 'agendada',
      titulo: 'Educação financeira como ferramenta de combate à pobreza',
      imageUrl: '/images/pratique-redacao.jpg',
      turmaIds: ['turma-1', 'turma-2'] },
    { id: 'prop-30', colecaoId: 'col-l3-10', dataAgendada: '2026-04-06', dataVisivel: '2026-04-06', status: 'agendada',
      titulo: 'O impacto do desmatamento da Amazônia na biodiversidade global',
      imageUrl: '/images/livro3.png',
      turmaIds: ['turma-2'] },
    // Semana 11 — 13/04
    { id: 'prop-31', colecaoId: 'col-pr-11', dataAgendada: '2026-04-13', dataVisivel: '2026-04-13', status: 'agendada',
      titulo: 'Desigualdade de gênero e as barreiras para a ascensão profissional feminina',
      imageUrl: '/images/pratique-redacao.jpg',
      turmaIds: ['turma-1', 'turma-2'] },
    { id: 'prop-32', colecaoId: 'col-l3-11', dataAgendada: '2026-04-13', dataVisivel: '2026-04-13', status: 'agendada',
      titulo: 'O futuro das cidades: urbanização sustentável e qualidade de vida',
      imageUrl: '/images/livro3.png',
      turmaIds: ['turma-1'] },
    // Semana 12 — 20/04
    { id: 'prop-33', colecaoId: 'col-pr-12', dataAgendada: '2026-04-20', dataVisivel: '2026-04-20', status: 'agendada',
      titulo: 'Povos indígenas: direitos territoriais e as pressões do agronegócio',
      imageUrl: '/images/pratique-redacao.jpg',
      turmaIds: ['turma-1', 'turma-2'] },
    { id: 'prop-34', colecaoId: 'col-l3-12', dataAgendada: '2026-04-20', dataVisivel: '2026-04-20', status: 'agendada',
      titulo: 'Trabalho análogo à escravidão: um crime persistente no Brasil contemporâneo',
      imageUrl: '/images/livro3.png',
      turmaIds: ['turma-2'] },
    // Semana 13 — 27/04
    { id: 'prop-35', colecaoId: 'col-pr-13', dataAgendada: '2026-04-27', dataVisivel: '2026-04-27', status: 'agendada',
      titulo: 'Doenças negligenciadas e o impacto na saúde das populações carentes',
      imageUrl: '/images/pratique-redacao.jpg',
      turmaIds: ['turma-1', 'turma-2'] },
    { id: 'prop-36', colecaoId: 'col-l3-13', dataAgendada: '2026-04-27', dataVisivel: '2026-04-27', status: 'agendada',
